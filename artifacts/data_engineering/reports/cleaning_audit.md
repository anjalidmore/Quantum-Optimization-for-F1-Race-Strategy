...
| Step | Detail | Rows before | Rows after | Extra |
|------|--------|-------------|------------|-------|
| `deduplicate` | Removed exact duplicate rows. | 1055 | 1055 | removed=0 |
| `coerce_types` | Coerced numeric/time/date columns; parsed lap times to seconds. | 1055 | 1055 |  |
| `normalise_categoricals` | Trimmed/upper-cased 7 categorical column(s). | 1055 | 1055 | columns=['Driver', 'Team', 'Compound', 'FreshTyre', 'TrackStatus', 'Rainfall', 'IsPersonalBest'] |
| `impute_missing` | Imputed numeric/time by median, categorical by mode. | 1055 | 1055 | na_before=72, na_after=0 |
| `detect_outliers` | Capped IQR outliers. | 1055 | 1055 | outliers={'LapNumber': 0, 'LapTime': 93, 'Stint': 18, 'TyreLife': 3, 'Sector1Time': 69, 'Sector2Time': 36, 'Sector3Time': 65, 'SpeedFL': 59, 'SpeedST': 106, 'AirTemp': 0, 'TrackTemp': 0, 'WindSpeed': 240} |
